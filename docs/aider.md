...
aider --openai-api-base "$OPENAI_API_BASE" --model openai/qwen25_15b_inf2_economy
```
...
- Use `openai/qwen25_15b_inf2_economy` for the conservative Inf2 Qwen coding profile.
