...
- Temporary EC2 capacity miss: Emberlane disables Terraform's ASG capacity wait, so transient AZ capacity retries should show in ASG activities/status instead of failing deploy.
