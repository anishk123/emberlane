...
fn inf2_runtime_pack_files_exist_and_models_are_defined() {
    ...
    assert!(models.contains("qwen25_15b_inf2_economy"));
...
fn render_env_outputs_llama_and_qwen_profiles() {
    ...
    assert!(text.contains("\"MODEL_ID\": \"Qwen/Qwen2.5-1.5B-Instruct\""));
...
fn start_server_contains_required_vllm_neuron_flags() {
    ...
    for needle in [
        ...
        "SYNC_ARTIFACTS_BACK",
        "using the Neuron Docker image for runtime launch",
